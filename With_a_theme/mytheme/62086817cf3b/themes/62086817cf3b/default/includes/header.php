...
if (array_key_exists('header', $this->data)) {
    ...
    echo 'custom_organisation';
}
?></title>

    <link rel="stylesheet" type="text/css" href="<?php echo SimpleSAML\Module::getModuleURL("custom_name/custom_name.css"); ?>" />
    <link rel="icon" type="image/icon" href="<?php echo SimpleSAML\Module::getModuleURL("custom_name/favicon.ico"); ?>" />
...
?>
	...
	<meta name="theme-color" content="#474746"/>
...
<div id="wrap">
    ...
    <div id="header">
        ...
        <h1><a href="/<?php echo $this->data['baseurlpath']; ?>"><?php
            echo(isset($this->data['header']) ? $this->data['header'] : 'custom_organisation');
        ?></a></h1>
    </div>
